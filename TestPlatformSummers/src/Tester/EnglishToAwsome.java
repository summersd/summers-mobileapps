...
public class EnglishToAwsome {
		private List<String []> dictionary;
		
		public EnglishToAwsome() {
			dictionary = new ArrayList<String []>(0);
			
			//Add words to the dictionary
			addEntry("house", "huzeee");
			addEntry("velcro", "welCROW");
			addEntry("book", "bawoook");
			addEntry("hammer", "hsaemnmseeri");
			addEntry("dude", "awsome");
		}
